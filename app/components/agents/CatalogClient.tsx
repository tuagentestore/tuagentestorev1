...
const STATIC_AGENTS: Agent[] = [
  ...
  { id: '7', name: 'Operations AI Agent', slug: 'operations-ai-agent', tagline: 'Automatiza procesos internos, reportes y flujos operativos', category: 'Operaciones', capabilities: ['Automatización de flujos', 'Reportes automáticos', 'Gestión de tareas'], integrations: ['Notion', 'Slack', 'Google Sheets'], pricing_basic: 397, pricing_pro: 597, featured: false, demo_available: false, setup_time_hours: 48, ideal_for: 'Startups, pymes, equipos operativos' },
]

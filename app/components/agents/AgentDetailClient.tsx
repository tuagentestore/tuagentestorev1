...
const ALL_AGENTS = [
  ...
  { id: '7', name: 'Operations AI Agent', slug: 'operations-ai-agent', tagline: 'Automatiza procesos internos, reportes y flujos operativos', category: 'Operaciones', pricing_basic: 447 },
]

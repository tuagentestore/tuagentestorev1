      ...
      <div className="max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        <div className="bg-card border border-border rounded-2xl overflow-hidden">
          ...
          {[
            ...
            { label: 'Starter', render: (a: Agent) => <span className="font-bold text-foreground">${a.pricing_basic}<span className="text-xs text-muted-foreground font-normal">/mes</span></span> },

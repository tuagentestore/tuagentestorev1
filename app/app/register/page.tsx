...
function RegisterForm() {
  ...
  const [error, setError] = useState<string | null>(
    oauthError === 'oauth_failed' ? 'Error al registrarse con Google. Intentá de nuevo.' : null
  )
  ...
  return (
    <div className="bg-card border border-border rounded-2xl p-8 space-y-4">
      ...
      <div className="flex items-center gap-3">
        ...
        <span className="text-xs text-muted-foreground">o creá una cuenta con email</span>
        <div className="flex-1 h-px bg-border" />
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div className="grid grid-cols-2 gap-3">
          ...
          <div className="col-span-2 sm:col-span-1">
            <label className="block text-sm font-medium text-foreground mb-1.5">Empresa <span className="text-muted-foreground font-normal">(opcional)</span></label>
            <input
              type="text"

...
function ContactForm() {
    ...
    return (
      <div className="text-center py-12">
        ...
        <p className="text-gray-400">
          Te contactamos en menos de 2 horas hábiles por email o WhatsApp.
        </p>
      </div>
    )
  }
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div>
        <label className="block text-sm text-gray-400 mb-1.5">¿En qué te podemos ayudar? *</label>
        <select
          value={form.type}
          onChange={(e) => setForm((f) => ({ ...f, type: e.target.value }))}
          className="w-full bg-[#0a0f1e] border border-gray-700 rounded-xl p-3 text-sm text-white focus:outline-none focus:border-blue-500"
        >

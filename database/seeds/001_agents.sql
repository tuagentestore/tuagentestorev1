-- ============================================================
-- TuAgenteStore — Seed: Agentes del catálogo
-- Ejecutar: docker compose exec postgres psql -U tuagentestore -d tuagentestore -f /backups/seeds/001_agents.sql
-- ============================================================
...
(
  ...
  ARRAY['E-commerce con alto volumen de leads', 'Agencias digitales', 'SaaS B2B', 'Servicios profesionales'],
...
(
  ...
  ARRAY['Startups en crecimiento', 'Inmobiliarias', 'Educación online', 'Fintech'],
...
(
  ...
  ARRAY['SaaS con muchos usuarios', 'E-commerce', 'Apps móviles', 'Servicios financieros'],
...
(
  ...
  ARRAY['Agencias de marketing', 'E-commerce', 'Marcas DTC', 'Medios digitales'],
...
(
  ...
  ARRAY['Tiendas Shopify/WooCommerce', 'Marcas de consumo', 'Suscripciones', 'Mayoristas online'],
...
(
  ...
  ARRAY['Consultoras', 'SaaS B2B', 'Servicios profesionales', 'Clínicas y salud'],
